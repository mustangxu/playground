 ...
 */
public class MiniJavaBaseVisitor<T> extends AbstractParseTreeVisitor<T>
        implements MiniJavaVisitor<T> {
    /**
     * {@inheritDoc}
     ...
     */
    @Override
    public T visitProgram(MiniJavaParser.ProgramContext ctx) {
