...
public class MiniJavaBaseListener implements MiniJavaListener {
    ...
    @Override
    public void
            enterClassDeclaration(MiniJavaParser.ClassDeclarationContext ctx) {
    }
    ...
    @Override
    public void
            exitClassDeclaration(MiniJavaParser.ClassDeclarationContext ctx) {
    }
    ...
    @Override
    public void
            exitMethodDeclaration(MiniJavaParser.MethodDeclarationContext ctx) {
    }
