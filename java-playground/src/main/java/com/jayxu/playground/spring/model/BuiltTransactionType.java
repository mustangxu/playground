...
public enum BuiltTransactionType {
    ...
    public static BuiltTransactionType codeOf(short code) {
        for (BuiltTransactionType enum1 : BuiltTransactionType.values()) {
    ...
    public static BuiltTransactionType descriptionOf(String description) {
        for (BuiltTransactionType enum1 : BuiltTransactionType.values()) {
            if (enum1.getDescription().equals(description)) {
                return enum1;
            }
        }
        return null;
    ...
    public static BuiltTransactionType ordinalOf(int iordinal) {
        if (iordinal < 0 || iordinal >= BuiltTransactionType.values().length) {
            return null;
        }
        return BuiltTransactionType.values()[iordinal];
    }
}
